...
export const User = ({id, email, first_name, last_name, avatar, onClickInveted, isInvited}) => (
  <li>
    <div>
    ...
    <img onClick={() => onClickInveted(id)} className="action" src={`/assets/${isInvited ? "minus" : "plus"}.svg`} alt="Action" />
  </li>
);
